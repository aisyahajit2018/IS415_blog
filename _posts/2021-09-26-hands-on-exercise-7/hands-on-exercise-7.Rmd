...
- the p-value which is 1.095e-06, means 1.095 times ten to the minus 6 power, or 0.00000058
- this means that if the confidence interval is 99%, it means that distribution of GDPPC values in the counties are not randomly distributed. 
...
- If the P value is 0.001, it indicates that if the null hypothesis were indeed true, then there would be only a 1 in 1000 chance of observing data this extreme. 
- This means that if the confidence interval is 99%, it means that distribution of GDPPC values in the counties are not randomly distributed. 
...
- This means that if the confidence interval is 99%, it means that distribution of GDPPC values in the counties are not randomly distributed. 
- Since the p-value is smaller than 1, the spatial pattern is “clustered”.
